...
class RemarkSoldItem(models.TransientModel):
	...
	def action_apply(self):
		...
		if active_model == 'sale.order':
			...
			picking_ids = self.env['stock.picking'].browse(self._context.get('params').get('id'))
		...
		pickings_without_moves = self.env['stock.picking']
		pickings_without_quantities = self.env['stock.picking']
		pickings_without_lots = self.env['stock.picking']
